...
import type { Animated, GestureResponderEvent, Pressable, StyleProp, TextStyle, ViewStyle } from 'react-native';
...
export type BottomTabBarButtonProps = Omit<React.ComponentProps<typeof Pressable>, 'style'> & {
    href?: string;
