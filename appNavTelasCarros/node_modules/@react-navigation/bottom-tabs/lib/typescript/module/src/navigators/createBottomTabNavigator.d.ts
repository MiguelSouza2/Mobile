...
declare function BottomTabNavigator({ id, initialRouteName, backBehavior, children, layout, screenListeners, screenOptions, screenLayout, UNSTABLE_getStateForRouteNamesChange, ...rest }: BottomTabNavigatorProps): import("react/jsx-runtime").JSX.Element;
