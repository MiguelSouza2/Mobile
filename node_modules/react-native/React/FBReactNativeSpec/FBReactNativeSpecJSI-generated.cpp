...
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_scrollTo(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->scrollTo(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : jsi::Value(rt, args[0]),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt)
  );
...
NativeFantomCxxSpecJSI::NativeFantomCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["scrollTo"] = MethodMetadata {2, __hostFunction_NativeFantomCxxSpecJSI_scrollTo};
